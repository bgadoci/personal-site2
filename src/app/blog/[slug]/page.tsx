...
export async function generateMetadata({ params }: PageProps) {
  ...
  const post = await getPostBySlug(params.slug, 'blog', false);
  ...
  return {
    ...
    description: `Blog post about ${post.title}`,
  };
}
  ...
  return (
    <article className="max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        {post.coverImage && (
          <div className="w-full h-64 md:h-80 lg:h-96 mb-6 overflow-hidden rounded-lg">
            <img 
