              ...
              <div key={relatedPost.slug} className="bg-white dark:bg-slate-800 rounded-lg shadow-sm overflow-hidden border border-slate-200 dark:border-slate-700">
                {relatedPost.coverImage && (
                  <div className="w-full h-40 overflow-hidden">
                    <img 
                      src={relatedPost.coverImage.startsWith('https://') ? relatedPost.coverImage : relatedPost.coverImage.startsWith('/') ? relatedPost.coverImage : `/images/blog-images/cover-images/${relatedPost.coverImage}`} 
